...
def swine_align(player_score, opponent_score):
    ...
    while max_score >= 10:
        if player_score % max_score == 0 and opponent_score % max_score == 0:
            return True
        max_score -= 1
    return False
    # END PROBLEM 4a
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    diff_score = player_score - opponent_score
    return diff_score < 0 and diff_score > -3
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            score = score1
        high_score = max(running_high, score - last_score)
        if high_score > running_high:
            print('{} point(s)! The most yet for Player {}'.format(high_score, who))
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def call_original_function(*args):
        sum = 0
        count = trials_count
        while count > 0:
